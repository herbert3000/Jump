...
public class ChocoladeSprite extends Sprite {

    double ySin;

    public ChocoladeSprite(Point3d point3d) {
        super.pos = World.makePos(point3d);
        super.shape = core.shapeHolder.getShape(3);
    ...
    public void update(double d) {
        super.shape.rotation.y = Math.cos(ySin) * 4D;
        ySin += d;
    }
    ...
    public String toString() {
    	return "ChocoladeSprite(" + World.makeSegPos(super.pos) + ")";
    }
}
