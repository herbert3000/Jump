...
public class CrystalSprite extends Sprite {

    double ySin;
    double yStartPos;

    public CrystalSprite(Point3d point3d) {
        super.pos = World.makePos(point3d);
        super.shape = core.shapeHolder.getShape(9);
    ...
    public String toString() {
    	return "CrystalSprite(" + World.makeSegPos(super.pos) + ")";
    }
}
