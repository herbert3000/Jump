...
public class DonutSprite extends Sprite {

    double ySin;
    double yStartPos;

    public DonutSprite(Point3d point3d) {
        super.pos = World.makePos(point3d);
        super.shape = core.shapeHolder.getShape(2);
    ...
    public String toString() {
    	return "DonutSprite(" + World.makeSegPos(super.pos) + ")";
    }
}
