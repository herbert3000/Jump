...
public class FallWindow extends ModifierWindow {
    ...
    private FallModifier m;
    GridBagLayout layout;
    GridBagConstraints gbc;

    public void setModifier(Modifier modifier) {
        m = (FallModifier)modifier;
        setTitle("Properties for FallModifier");
        pack();
        resize(170, 180);
        layItOut();
        show();
